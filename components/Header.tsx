...
// const NavItem = ({ itemData }: { itemData: NavItemData }) => {
//   return (
//     <Link
//       style={{
//         pointerEvents: itemData.enabled ? "auto" : "none",
//         opacity: itemData.enabled ? 1 : 0.3,
//       }}
//       href={itemData.href}
//     >
...
//           src={`/navicons/${itemData.name}.png`}
//           width={40}
//           height={40}
//           alt="logo"
//         />
//         <div className="hidden md:block">{itemData.name}</div>
//       </div>
//     </Link>
//   );
// };
...
//         alt="logo"
//       />
//     <div className="flex items-center justify-between p-2 pr-[30px]">
//       {NAV_ITEMS.map((item) => (
//         <NavItem key={item.name} itemData={item} />
//       ))}
//     </div>
//     <div >
//     <Link href="https://discord.gg/phygitals" className="flex gap-2"> 
//       <Image 
//           className="object-cover"
//           src="/discord.png"
//           width={40}
